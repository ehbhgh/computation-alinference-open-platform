  ...
  <div class="container_warp">
    ...
    <div class="operating">
      ...
      <div class="btn-group">
        ...
        <Tooltip content="删除画布" placement="bottom">
          <div class="btn" @click="deleteCanvas()" style="margin-top: 5px;">
            <i class="iconfont icon-shanchu"></i>
          </div>
        </Tooltip>
        ...
        <Tooltip content="保存Json" placement="bottom">
          <div class="btn" @click="saveToJson()" title="保存Json">
            <i class="iconfont icon-baocun"></i>
          </div>
        </Tooltip>
      </div>
